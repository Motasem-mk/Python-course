...
if x<0:
    raise Exception(f"x = {x} is < 0 ")
    print("this message will not be printed because of the error ")
else :
    print("this message if the condition doesnt meet")
